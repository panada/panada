...
class PropertiesLoader
{
    ...
    public function __call($name, $arguments = array())
    {
        ...
        $object->library    = new self($this->childNamespace, 'Libraries');
        $object->model      = new self($this->childNamespace, 'Models');
        $object->resource   = new self($this->childNamespace, 'Resources');
