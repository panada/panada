...
function __autoload($class_name) {
    ...
    //EN: Convert undersoce into slash.
    ...
    if( $prefix[0] == 'library' ){
        ...
        //EN: Does the file exist un main library folder?
	if( file_exists( $libsys_file = THISPATH . GEAR . $file . '.php' ) ) {
        ...
        //EN: Oops! Panada Cant'f find anywhere, so stop the execution!
	else{
 ...
 * @package	Panda
 * @category	Main System
 * @author	kandar (modified from CI_Base class for PHP5)
 * @since	Version 0.1
 */
class Panada {
     ...
     * ID: Menghapus prefix nama folder yang ada pada bagian awal nama file untuk menjadi nama file.
     *
     * @access public
     * @param string
     * @return string
...
/**
 * EN: End of the cicle, lets clear the memory
 * unset($Panada);
 */