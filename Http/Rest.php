...
class Rest
{
    ...
    public $setRequestHeaders = array();
    public $responseOutputHeader = false;
    public $timeout = 30;
    public $curlSSLVerifypeer = true;
    public $requestHeaders = array('User-Agent' => 'Panada PHP Framework REST API/0.3');
